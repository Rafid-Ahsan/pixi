                    ...
                    <x-jet-dropdown align="right" width="60">
                        ...
                        <x-slot name="content">
                            <div class="w-60">
                                ...
                                <!-- Team Settings -->
                                <x-jet-dropdown-link href="{{ route('single_image.create', Auth::user()->id) }}">
                                    Single Image
                                </x-jet-dropdown-link>

                                <x-jet-dropdown-link href="{{ route('catalog.create', Auth::user()->id) }}">
                                    Catalog
                                </x-jet-dropdown-link>

                                <x-jet-dropdown-link href="{{ route('blog.create', Auth::user()->id) }}">
                                    Blog
                                </x-jet-dropdown-link>
                            </div>
                        </x-slot>
