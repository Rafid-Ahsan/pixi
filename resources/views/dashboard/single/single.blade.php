                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                        <div class="flex flex-wrap no-underline hover:no-underline">
                            <a href=""><img src="{{ Storage::url('uploads/single-image/'. $single->image) }}" class="h-64 w-full rounded-t pb-6"></a>
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="{{ $single->name }}" src="{{ asset('storage/'. Auth::user()->profile_photo_path)}}" alt="Avatar of Author">
                            <p class="text-gray-600 text-xs md:text-sm">{{ $single->team_name }}</p>
                        </div>
                    </div>
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <a href="{{ route('blog.showUpdateForm', $single->id) }}" class="bg-blue-800 text-white p-3 text-xs md:text-sm">Update</a>
