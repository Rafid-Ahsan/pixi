            ...
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                ...
                <form method="post" action="{{ route('blog.update', $blog->id) }}" class="block p-5">
                    ...
                    <div class="md:flex md:items-center mb-6">
                        ...
                        <div class="md:w-2/3">
                            <input name="title" class="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" value="{{ $blog->title }}">
                        </div>
                    </div>
                    <div class="md:flex md:items-center mb-6">
                        <div class="md:w-1/3">
                        ...
                        <div class="md:w-2/3">
                            <textarea name="description" class="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text">{{ $blog->description }}</textarea>
                        </div>
                    </div>
                    <div class="md:flex md:items-center mb-6">
                        <div class="md:w-1/3">
